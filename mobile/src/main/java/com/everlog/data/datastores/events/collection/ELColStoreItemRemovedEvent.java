...
public class ELColStoreItemRemovedEvent<T> extends BaseEvent {
    ...
    public ELColStoreItemRemovedEvent(int position,
                                      T item,
    ...
    public boolean equals(Object o) {
        ...
        ELColStoreItemRemovedEvent<?> that = (ELColStoreItemRemovedEvent<?>) o;
