...
public class BitmapUtils {
	...
	public static Bitmap getImageFromUriForCurrentDisplay( Context ctx, Uri uri ) throws IOException {
		InputStream iStream = ctx.getContentResolver().openInputStream( uri );
		byte[] inputData = getBytes( iStream );
		
		return decodeSampledBitmapFromBytesForCurrentScreen( inputData, ctx );
	}
	...
	public static Bitmap decodeSampledBitmapStreamForSize( InputStream is, int reqWidth, int reqHeight ) throws IOException {
